    ...
    <div className="min-h-screen relative overflow-hidden text-[#1A0905]" style={{ backgroundColor: "#E3DFCE" }}>
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 pt-32 pb-14 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-xl max-w-3xl mx-auto leading-relaxed" style={{ color: "#1A0905" }}>
        ...
        {/* Why Join Section */}
        <div className="mb-16">
          <h2 className="text-3xl md:text-4xl font-editorial-serif font-semibold text-center mb-12" style={{ color: "#1A0905" }}>
            Why Join Our Community?
          </h2>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            <Card className="text-center p-6 rounded-[24px] border-2 border-[#1A0905] bg-[#f7f4eb] shadow-[6px_6px_0px_rgba(26,9,5,0.55)] transition-all duration-500 hover:-translate-y-1">
              ...
              <h3 className="text-lg font-semibold mb-2" style={{ color: "#1A0905" }}>
                Global Impact
              </h3>
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
            {/* Member Application */}
            <div className="relative overflow-hidden rounded-[28px] p-10 border-2 border-[#1A0905] bg-[#f7f4eb] shadow-[8px_8px_0px_rgba(26,9,5,0.76)] transition-all duration-700 hover:shadow-[11px_11px_0px_rgba(26,9,5,0.76)] group">
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-3xl font-editorial-serif font-semibold mb-4" style={{ color: "#1A0905" }}>
                  Become a Member
                </h3>
        ...
        {/* CTA Section */}
        <div className="relative overflow-hidden rounded-[30px] p-12 text-center border-2 border-[#1A0905] bg-[#4C050C] shadow-[10px_10px_0px_rgba(26,9,5,0.75)]">
          {/* Decorative shapes */}
          ...
          <div className="relative z-10 max-w-2xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-editorial-serif font-semibold mb-4" style={{ color: "#E3DFCE" }}>
              Questions?
            </h2>
            <p className="text-lg mb-8" style={{ color: "#E3DFCE" }}>
              If you have any questions about joining AnithUncommon, feel free to reach out to us.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button 
                size="lg" 
                className="text-lg border-2 border-[#1A0905]"
              ...
              <Button 
                size="lg"
                variant="outline"
                className="text-lg border-2 border-[#E3DFCE]"
                style={{ color: "#E3DFCE", backgroundColor: "transparent" }}
